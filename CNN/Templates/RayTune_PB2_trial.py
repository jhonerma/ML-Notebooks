...
# combine several batches into one backprop to circumvent GPU memory limitat
...
# Implementation of pytorch dataset class, loads the full dataset into ram.
# Can be used for datapreprocessing and augmentation.
...
class ClusterDataset_Full(utils.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels = {"PartE": _PartE, "PartPt": _PartPt, "PartEta": _PartEta,
...
def test_accuracy(model, device="cpu"):
    ...
    dataloader_test = utils.DataLoader(
        ...
        num_workers=cpu_count()-1, pin_memory=pin_memory)
...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    print(f"Best trial final validation accuracy: "
          f"{best_trial.last_result['mean_accuracy']}")
